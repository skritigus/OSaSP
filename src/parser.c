...
void printStat(CPU* cpu)
{
    ...
    printf("RAH: ");
    printNum(fixed32ToFloat(cpu->registers[RAX].parts.high));
    printf("RAL: ");
    printNum(fixed32ToFloat(cpu->registers[RAX].parts.low));
    
    printf("RBX: ");
    printNum(fixed64ToFloat(cpu->registers[RBX].value));
    printf("RBH: ");
    printNum(fixed32ToFloat(cpu->registers[RBX].parts.high));
    printf("RBL: ");
    printNum(fixed32ToFloat(cpu->registers[RBX].parts.low));
    
    printf("RCX: ");
    printNum(fixed64ToFloat(cpu->registers[RCX].value));
    printf("RCH: ");
    printNum(fixed32ToFloat(cpu->registers[RCX].parts.high));
    printf("RCL: ");
    printNum(fixed32ToFloat(cpu->registers[RCX].parts.low));
    
    printf("RDX: ");
    printNum(fixed64ToFloat(cpu->registers[RDX].value));
    printf("RDH: ");
    printNum(fixed32ToFloat(cpu->registers[RDX].parts.high));
    printf("RDL: ");
    printNum(fixed32ToFloat(cpu->registers[RDX].parts.low));
    printf("\n");
}
